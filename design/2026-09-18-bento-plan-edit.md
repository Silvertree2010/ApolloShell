...
- The render comparison must stay as it is now for the normal (non-edit) pages: `python3 scripts/compare-renders.py <baseline> <new>` → 6 files `same`, the two `dashboard-*` files at 555/565 px (known calendar rounding, see spec "Testing"). Check this after Tasks 3 and 5.
